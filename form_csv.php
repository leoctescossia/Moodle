...
class local_greetings_csv_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('filepicker', 'csvfile', get_string('uploadcsv', 'local_greetings'), null, array('accepted_types' => '.csv'));
        $mform->addRule('csvfile', null, 'required', null, 'client');

        // Botões de ação (submit e cancel).
        $this->add_action_buttons(true, get_string('submitcsv', 'local_greetings'));
    }
